...
public class Invite {
    ...
    public Invite(int invite_ID, String invited_by, int patient_ID, String patient_name,
                  String invited_email, String invited_relationship, int invited_admin, int invite_accepted) {
